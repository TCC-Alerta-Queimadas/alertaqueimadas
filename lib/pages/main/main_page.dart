...
import 'package:alertaqueimada/pages/consulta/consulta_page.dart';
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<UsuarioModel?>(
        ...
        builder: (context, usuario, widget) {
          return usuario != null && (usuario.id?.length ?? 0) > 0
              ? ConsultaPage()
              : Scaffold(
                  appBar: AppBar(
                    actions: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                'Clique acima para enviar a foto e o local do incêndio!',
                                style: TextStyle(
...
Future<void> _denunciar(BuildContext context) async {
  ...
  DenunciaModel denuncia =
      DenunciaModel(foto: foto, posicao: posicao, direcao: direcao);
  Navigator.of(context).push(MaterialPageRoute(
